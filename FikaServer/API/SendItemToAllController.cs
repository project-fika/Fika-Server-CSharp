...
[ApiController]
[Route("fika/api/senditemtoall")]
[RequireApiKey]
public class SendItemToAllController(MailSendService mailSendService, ItemHelper itemHelper,
    PresetHelper presetHelper, ICloner cloner) : ControllerBase
{
    ...
    [HttpPost]
    public IActionResult HandlePostRequest([FromBody] SendItemToAllRequest request)
    {
